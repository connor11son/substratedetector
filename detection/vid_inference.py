...
def main(args):
    ...
    create_list(args.vid, args.k, FRAMES_LIST_HOME)
    ...
    save_frames_to_path(args.vid, fnums, FRAMES_HOME)
    ...
    dataloader = torch.utils.data.DataLoader(image_dataset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers)
